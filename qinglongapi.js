 ...
 * @Last Modified time: 2022-03-06
 * @Desc: 青龙依赖
 */
const axios = require('axios')
const QL_URL = 'http://192.168.31.33:5700'
const QL_username = 'username';
const QL_password = 'passwd';
...
async function getQLToken() {
  try {
    ...
    console.error('获取访问令牌时出错:', error.response.data);
    return null;
  }
}
